...
```shell
wsl --list --online / wsl -l -o # 列举现有的可安装的发布版本
wsl --install <DistributionName> # 安装指定的发布版本，如果下载慢可去 Microsoft Store 下载
wsl --list --verbose / wsl -l -v # 查看已安装的实例
wsl --unregister <DistributionName> # 注销实例
```
